...
Use GitHub's [private vulnerability reporting](https://github.com/IcebergAI/skilldeck/security/advisories/new)
...
small team and we'll move as fast as we can.

## Supported versions

skilldeck is pre-1.0 and ships fixes against the latest release. Please make sure
